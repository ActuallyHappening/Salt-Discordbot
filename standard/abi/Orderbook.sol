library ExchangeOrderbook {
    struct Order { address owner; uint256 price; uint256 depositAmount; }
}
...
interface IOrderbook {
    ...
    function execute(uint32 orderId, bool isBid, address sender, uint256 amount, bool clear) external returns (address owner);
    ...
    function sfpop(bool isBid, uint256 price, uint32 orderId, bool isHead) external view returns (uint32 id, uint256 required, bool clear);
